...
import Banner1 from "../../public/banner/laco.png";
import Banner2 from "@/public/banner/muonmanglatuluc.png";
import Banner3 from "@/public/banner/yeuthuongtiepnoi.png";
...
export default function Carousel() {
    return (
        ...
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            <Image
                src={Banner1} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div>
            {/* Item 2 */}
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
